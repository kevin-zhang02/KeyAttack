...
AUDIO_DIR = os.path.abspath('../Keystroke-Datasets/MBPWavs/processed')
...
def train():
    ...
    torch.save(model.state_dict(), os.path.join(MODEL_PATH, "Model"))
    with open(os.path.join(MODEL_PATH, "LabelIndices"), 'w') as f:
